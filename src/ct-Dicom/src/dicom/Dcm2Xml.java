 ...
 * @version $Revision: 1.6 $ $Date: 2005/10/05 19:40:23 $
 * @since Aug 15, 2005
 */
...
*/
    ...
    public static void convert(String sourcefile, String convertedfile, boolean writeoutputfile) {
        Dcm2Xml dcm2xml = new Dcm2Xml();
        File ifile = new File(sourcefile);
        File ofile = null;
        if (writeoutputfile) {
            ofile = new File(convertedfile);
        ...
        */
        ...
        try {
            dcm2xml.literallyConvert(ifile, ofile);
    ...
    public void literallyConvert(File ifile, File ofile) throws IOException,
